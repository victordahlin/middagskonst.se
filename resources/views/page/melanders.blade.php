  ...
  <div class="col-md-12 col-xs-12">
    ...
    <div class="row">
      <div class="products">
        ...
        @for($i = 0; $i < sizeof($products); $i++) @if(strpos($products[$i]->title,'Melanders')!==false)
          ...
          <div class="col-xs-12">
            ...
            <hr>
            @for($i = 0; $i < sizeof($menus); $i+=2) <div class="row">
              <div class="col-lg-12">
              ...
              <div class="col-md-12 col-xs-12">
                ...
                @if($menu->week === $menus[$i]->week && strpos($menu->title,'Melanders')!==false)
                <div class="trigger-button">
                  <span>{{ $menu->title }}</span>
                </div>
                <div class="accordion">
                  <div class="note light">
                    @if(strpos($menu->title,'Skaldjurspåse')!==false)
                    <p>{!! $menu->text !!}</p>
                    @else
